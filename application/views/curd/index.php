...
<div class="row">
    <div class="col-lg-6">
        <table id="users_info" class="table table-bordered">
            ...
            <div class="card-body">
                <form method ="post" id="add-info-form" >
                    ...
                    <div class="form-group">
                        ...
                        <div id="invalid-pos" class="invalid-feedback"></div>
                    </div>
                    <div class="form-group">
                        <label for="position">Enter Email</label>
...
<!-- The Modal -->
<div class="modal fade" id="delete-info" role="dialog">
